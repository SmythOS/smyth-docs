...
og:image: /img/integrations/smythos_airtable.png
...
- Sync data from [Google Sheets](/docs/agent-studio/integrations/output/google-sheets-integration) or [PDF Generator](/docs/agent-studio/components/convert/pdf-generator).
- Parse and log records via [Email Parser](/docs/agent-studio/components/utility/email-parser).
- Use `Get Record` to fetch CRM data before replying to a user via OpenAI.

<Image src="/img/integrations/smythos_airtable.png" alt="SmythOS Airtable Integration Visual" />