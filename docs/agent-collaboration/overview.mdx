...
<InfoCallout title="TL;DR">Use [Spaces](/docs/agent-collaboration/spaces/) to organize your projects, the [Vault](/docs/agent-studio/key-concepts/vault) to share secrets securely, and granular [Roles](/docs/agent-collaboration/user-management) to manage team access. </InfoCallout>
...
| **[Roles & Permissions](/docs/agent-collaboration/user-management)** | Granular access control for users and agents.                          | Teams of any size, especially those with stakeholders.   | Give everyone the exact level of access they need.        |
...
2.  **Invite Team Members & Assign Roles**
    Once your Space is ready, [invite your colleagues](/docs/account-management/organization-management) or clients. As they join, assign them specific [Roles and Permissions](/docs/agent-collaboration/user-management) like `Admin`, `Editor`, or `Viewer` to define exactly what they can do within that Space.
...
<CardGrid>
  ...
  <Card
    ...
    to="/docs/agent-collaboration/user-management"
  />
  <Card
