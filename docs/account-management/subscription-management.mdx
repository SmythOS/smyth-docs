...
To monitor usage, check the [Analytics Dashboard](/docs/account-management/user-management).

<Spacer size="md" />

## Cancel a Subscription
<InfoCallout title="Only team owners can cancel subscriptions">
If you don’t see the cancel option, check your [role and permissions](/docs/account-management/user-management). Only the [team owner](/docs/account-management/organization-management) has permission to cancel the plan.
</InfoCallout>
...
- [Analytics Dashboard](/docs/account-management/user-management)
