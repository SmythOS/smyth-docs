...
- Optionally configure [Vault → API Keys](/docs/agent-collaboration/working-with-agents/vault) for securely managing your Bot Token
...
<InfoCallout>
Keep your Bot Token secure in [Vault → API Keys](/docs/agent-collaboration/working-with-agents/vault).
</InfoCallout>
