...
<Image src="/docs/img/agent_deployments/agent-cloud.jpg" />
...
Use [**SmythOS Runtime Environment (SRE)**](/docs/agent-runtime/overview) for local testing and development. It is fast, private, and offline.
