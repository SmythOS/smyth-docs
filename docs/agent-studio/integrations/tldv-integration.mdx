...
description: Connect SmythOS to tl;dv to automatically retrieve meeting recordings, transcripts, and highlights directly within your agent workflows.
...
<InfoCallout>This component requires an `API Key` for authentication, as detailed in the [Getting Started](#getting-started-with-tldv) section.</InfoCallout>
...
* **Explore Other Integrations:**
    * Feed transcripts from tl;dv into the [OpenAI Whisper](/docs/integrations/fal-ai) or other advanced speech models for further analysis or re-transcription if needed.
    * Log meeting summaries and action items into a [Notion](/docs/integrations/notion) database or [Google Sheet](/docs/agent-studio/integrations/google-sheets-integration).
    * Send automated meeting summary emails to all participants using the [Email](/docs/integrations/email) integration.
