...
<Image src="/img/inventory_agent/Image 1.png" alt="alt text" /> 
...
<Image src="/img/inventory_agent/Image 2.png" alt="alt text" /> 
...
<Image src="/img/inventory_agent/Image 3.png" alt="alt text" /> 
...
<Image src="/img/inventory_agent/Image 4.png" alt="alt text" /> 
...
<Image src="/img/inventory_agent/Image 5.png" alt="alt text" />
...
<Image src="/img/inventory_agent/Image 39.png" alt="alt text" />

2. Click `Import Customers`.

<Image src="/img/inventory_agent/Image 40.png" alt="alt text" />

3. You can drag and drop your CSV file or click to select a file.

<Image src="/img/inventory_agent/Image 41.png" alt="alt text" />

4. Once your file is ready, click `next` to proceed.

<Image src="/img/inventory_agent/Image 42.png" alt="alt text" />

5. Then, click `Import`.

<Image src="/img/inventory_agent/Image 43.png" alt="alt text" />

6. Once the import process is successful, InFlow will notify you via email.

<Image src="/img/inventory_agent/Image 44.png" alt="alt text" />
...
<Image src="/img/inventory_agent/Image 45.png" alt="alt text" />

2. Click `Import Vendors`.

<Image src="/img/inventory_agent/Image 46.png" alt="alt text" />

3. You can drag and drop your CSV file or click to select a file.

<Image src="/img/inventory_agent/Image 47.png" alt="alt text" />

4. Once your file is ready, click `next` to proceed.

<Image src="/img/inventory_agent/Image 48.png" alt="alt text" />

5. Then, click `Import`.

<Image src="/img/inventory_agent/Image 49.png" alt="alt text" />

6. Once the import process is successful, InFlow will notify you via email.

<Image src="/img/inventory_agent/Image 50.png" alt="alt text" />
...
<Image src="/img/inventory_agent/Image 51.png" alt="alt text" />

2. Click `Import Products`.

<Image src="/img/inventory_agent/Image 52.png" alt="alt text" />

3. You can drag and drop your CSV file or click to select a file.

<Image src="/img/inventory_agent/Image 53.png" alt="alt text" />

4. Once your file is ready, click `next` to proceed.

<Image src="/img/inventory_agent/Image 54.png" alt="alt text" />

5. Then, click `Import`.

<Image src="/img/inventory_agent/Image 55.png" alt="alt text" />

6. Once the import process is successful, InFlow will notify you via email.

<Image src="/img/inventory_agent/Image 56.png" alt="alt text" />

## InFlow Inventory Template Setup

1. Go to your SmythOS Dashboard and click on the Create Agent button.

<Image src="/img/inventory_agent/Image 6.png" alt="alt text" />
...
<Image src="/img/inventory_agent/Image 7.png" alt="alt text" />
...
<Image src="/img/inventory_agent/Image 8.png" alt="alt text" />

2. Don't forget to click the check mark icon to save your configuration.

### Adding API Key to the Vault

> To know more about the Vault feature, please visit the following link [Vault Documentation](https://app.smythos.com/doc/#/vault/keysManagement).

Your API Key will be needed on your API Call components.

1. Navigate to the Vault section on your dashboard

<Image src="/img/inventory_agent/Image 9.png" alt="alt text" />

2. Click the `Add Key` button to add your InFlow API Key.

<Image src="/img/inventory_agent/Image 10.png" alt="alt text" />
...
<Image src="/img/inventory_agent/Image 11.png" alt="alt text" />

4. Choose a unique Key name.
   1. **Example:** InFlow Inventory API Key

<Image src="/img/inventory_agent/Image 12.png" alt="alt text" />

5. Choose `API Call` for the Scope.

<Image src="/img/inventory_agent/Image 13.png" alt="alt text" />

6. Click `Done` to save your API Key. Your InFlow API Key has been successfully added to your Vault and is now ready for use.

<Image src="/img/inventory_agent/Image 14.png" alt="alt text" />
...
<Image src="/img/inventory_agent/Image 15.png" alt="alt text" />
...
<Image src="/img/inventory_agent/Image 16.png" alt="alt text" />
...
<Image src="/img/inventory_agent/Image 17.png" alt="alt text" />

4. When you successfully configure your API Call component, the error message will disappear.

<Image src="/img/inventory_agent/Image 18.png" alt="alt text" />
...
<Image src="/img/inventory_agent/Image 19.png" alt="alt text" />

3. Ask the agent to get a category list.

<Image src="/img/inventory_agent/Image 20.png" alt="alt text" />

4. The agent will now furnish you with the product categories in your InFlow inventory.

<Image src="/img/inventory_agent/Image 21.png" alt="alt text" />

### Get Customer List

1. Ask the agent to retrieve the list of customers.

<Image src="/img/inventory_agent/Image 22.png" alt="alt text" />
...
<Image src="/img/inventory_agent/Image 23.png" alt="alt text" />

3. You can also view the full list of the customers with the link provided by the Agent.

<Image src="/img/inventory_agent/Image 24.png" alt="alt text" />

### Get Customer Details

1. Ask the agent to get some customer details.

<Image src="/img/inventory_agent/Image 25.png" alt="alt text" />
...
<Image src="/img/inventory_agent/Image 26.png" alt="alt text" />
...
<Image src="/img/inventory_agent/Image 27.png" alt="alt text" />

### Add new products to the inventory

1. Instruct the agent that you wish to add a product to the inventory.

<Image src="/img/inventory_agent/Image 28.png" alt="alt text" />
...
<Image src="/img/inventory_agent/Image 29.png" alt="alt text" />
...
<Image src="/img/inventory_agent/Image 30.png" alt="alt text" />
...
<Image src="/img/inventory_agent/Image 36.png" alt="alt text" />

<Image src="/img/inventory_agent/Image 37.png" alt="alt text" />
...
<Image src="/img/inventory_agent/Image 38.png" alt="alt text" />
