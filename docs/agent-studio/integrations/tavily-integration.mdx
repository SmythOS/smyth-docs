...
* **Explore Other Integrations:**
    * Combine Tavily with the [OpenRouter](/docs/agent-studio/integrations/openrouter-integration) or [Perplexity AI](/docs/integrations/perplexity-ai) integrations to create state-of-the-art RAG pipelines.
    ...
    * Use the `Extract` component to get clean article text and then pass it to the [PlayHT](/docs/integrations/playht) or [Elevenlabs](/docs/agent-studio/integrations/elevenlabs-integrationns/elevenlabs-integration) integrations to create an audio version.
