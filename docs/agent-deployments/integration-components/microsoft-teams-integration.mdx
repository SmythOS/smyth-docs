...
## Why Use Microsoft Teams Your Agent?
...
- Your SmythOS agent should be deployed with [Vault access configured](/docs/agent-collaboration/working-with-agents/vault-sharing)
...
- Monitor agent-to-Teams traffic in [Agent Logs](/docs/agent-studio/agent-settings/logs)
...
- Use [Data Spaces](/docs/agent-collaboration/working-with-agents/data-spaces) to enrich or personalize messages
