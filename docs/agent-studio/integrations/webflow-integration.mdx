...
* **Explore Other Integrations:**
    * Use an [LLM component](/docs/integrations/openrouter) to generate a blog post, then use `Create Collection Item` and `Publish Item` to publish it.
    * When a new item is published, take its URL and share it across your social channels using the [Ayrshare Integration](/docs/integrations/ayrshare).
    * Log every new CMS item created by your agents into a [Google Sheet](/docs/integrations/google-sheets) for content auditing and tracking.
