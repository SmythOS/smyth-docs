...
* **Build an Agent That...**
    ...
    * Connects to a translation service (via its OpenAPI spec) to translate text, and then uses the [Elevenlabs Integration](/docs/integrations/elevenlabs) to read the translation aloud.
