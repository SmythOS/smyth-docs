...
**Data Spaces** are named containers in the [Data Pool](../../data-pool) that hold files or URLs. These sources are indexed using vector embeddings so your agents can retrieve and use them through **retrieval-augmented generation (RAG)**.
...
<Image src="/static/docs/img/docs/create-data-space-popup.jpg" alt="Create Data Space modal" caption="Each Data Space represents a dedicated container of searchable documents." />
...
<Image src="/static/docs/img/docs/add-data-source-popup.jpg" alt="Add Data Source modal in SmythOS" caption="Files and links are transformed into searchable vector embeddings." />
...
Indexing turns your files into vector embeddings. These are stored in your default or [Custom Storage](../../data/custom-storage) setup and made available to agents via semantic search.
</InfoCallout>
...
1. Open your [Project Space](../spaces)
...
Check file type and size. Retry if needed, or consider using [Custom Storage](../../data/custom-storage) for more control.

<Spacer size="md" />

## What's Next?

- [Explore the full Data Pool](../../data-pool)
- [Use Custom Storage integrations](../../data/custom-storage)
- [Connect data to agents in Spaces](../spaces)
- [Track how agents use data in Analytics](../../analytics/overview)
