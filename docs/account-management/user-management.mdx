...
<Image src="/docs/img/agent_collaboration/user-invites-table.png" alt="Pending User Invites Table in SmythOS" caption="Track and manage pending team invites from a single place." />
...
- Check [Permissions](/docs/account-management/user-management) to ensure agents aren't over-accessed
...
Only **Super Admins** and **Editors**. [Review roles here](/docs/account-management/user-management).
