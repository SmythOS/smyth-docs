...
The Smyth Runtime Environment offers a vast set of over 40 production-ready components. These building blocks help you construct powerful and flexible [AI agents](/docs/sre/building-agents).
...
- **[Building Agents](/docs/sre/building-agents)**: See how to combine these components into workflows.
- **[SDK Guide](/docs/sre/sdk-guide)**: Learn to programmatically add and configure components.
- **[Core Concepts](/docs/sre/core-concepts)**: Understand the architecture that powers these components.