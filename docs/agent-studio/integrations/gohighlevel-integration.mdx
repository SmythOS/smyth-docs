...
|---------------|------------|------------------|------------|------------------|---------------|
| [**Create Contact**](#create-contact) | Write | Creates a new contact in a specific location. | <Badge type="required" /> `email`<br/><Badge type="optional" /> `firstName`, `phone` | `id`, `locationId` | Adding a new lead from a website form. |
| [**Update Contact**](#update-contact) | Write | Updates the fields of an existing contact. | <Badge type="required" /> `contactId`, `Body` | `id`, `email` | Updating a contact's details from a CRM. |
...
| [**Delete Contact Campaigns**](#delete-contact-campaigns)| Write | Removes a contact from all campaigns. | <Badge type="required" /> `contactId` | `Response` | Opting a user out of all marketing. |
...
| [**Update Task Status**](#update-task-status) | Write | Updates the status of a task to complete or incomplete. | <Badge type="required" /> `contactId`, `taskId`, `status`| `id`, `isCompleted`| Marking a task as done from another system. |
...
| [**Get Contact Notes**](#get-contact-notes) | Read | Retrieves all notes for a specific contact. | <Badge type="required" /> `contactId` | `notes` | Getting historical context on a customer. |
...
| **Find a contact** before updating them | An email or phone number | [Search Contact](#search-contact) | The best way to check for duplicates and get a `contactId`. |
...
### <a name="create-tag"></a>Create Tag
...
### <a name="get-all-tags"></a>Get All Tags
...
### <a name="update-tag"></a>Update Tag
...
### <a name="get-pipelines"></a>Get Pipelines
...
### <a name="get-opportunity"></a>Get Opportunity
...
### <a name="delete-opportunity"></a>Delete Opportunity
...
### <a name="update-opportunity-status-and-stage"></a>Update Opportunity Status and Stage
...
### <a name="get-campaigns"></a>Get Campaigns
...
### <a name="find-user-by-email"></a>Find User by Email
Finds a user by their email address. This component requires an Agency-level API Key.

<InfoCallout>This component requires an `Agency API Key` for authentication.</InfoCallout>
...
### <a name="get-all-agency-users"></a>Get All Agency Users
...
### <a name="get-agency-user"></a>Get Agency User
...
### <a name="get-location-users"></a>Get Location Users
...
### <a name="create-opportunity"></a>Create Opportunity
...
### <a name="update-opportunity"></a>Update Opportunity
...
* **Explore Other Integrations:**
    * When a new contact is created in GoHighLevel, trigger an agent to also add them to a specific email list in [Mailchimp](/docs/integrations/mailchimp) or [Klaviyo](/docs/integrations/klaviyo).
    * Connect GoHighLevel to a payment processor like [Stripe](/docs/integrations/stripe-integration). When a new customer is created in Stripe, create or update the corresponding contact in GoHighLevel.
