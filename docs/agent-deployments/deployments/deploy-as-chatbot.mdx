...
<Image
  src="/docs/img/agent_deployments/chatbot-config-ui.png"
...
| **Enable Meta Messages** | Display real-time skill execution information (skill name, input parameters, and output results) in the chatbot during agent skill calls | Helpful for transparency and debugging; only visible when deployed on external websites |
