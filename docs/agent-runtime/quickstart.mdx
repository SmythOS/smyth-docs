...
Build your first real AI agent with behavior, skills, and prompt flow using the [Smyth SDK](/docs/agent-runtime/sdk-guide).
</InfoCallout>
...
You can build simple workflows by connecting modular [Components](/docs/agent-runtime/components). This example uses `SDK.GenAILLM` and `SDK.Classifier`.
...
- [Learn how SRE's architecture works](/docs/agent-runtime/architecture)
