...
* **Build an Agent That...**
    * Takes the text from a scraped web article ([ScrapingBee](/docs/integrations/scrapingbee)), converts it to audio with PlayHT, and saves the MP3 file to [OneDrive](/docs/integrations/onedrive).
