...
The SmythOS Runtime Environment (SRE) provides over 40 production-ready components, building blocks you can combine to create robust [AI agents](/docs/agent-runtime/building-agents).  
