...
[Deploy Version UI](./images/deploy-version-ui.jpg)

- **Major** and **Minor** fields are required.
- You’ll also see the auto-generated subdomain and the optional release notes field.

If you're using [custom domains](/docs/agent-deployment/subdomains), your version still applies regardless of URL.
...
<InfoCallout>
There’s no concept of patch or build numbers (e.g., `1.0.1`) in SmythOS — keep it simple with `Major.Minor`.
</InfoCallout>
...
- Ready to deploy? See [Deployment Quick Start](/docs/agent-deployment/quickstart)
