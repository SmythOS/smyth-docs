...
* **Build an Agent That...**
    ...
    * Manages your release process. When a developer merges a PR into the `release` branch in [GitHub](/docs/integrations/github), an agent finds all related Jira issues and transitions them to a "Ready for Release" status.
...
* **Explore Other Integrations:**
    * When a new issue is created, send a notification to a [Slack](/docs/integrations/slack) or [Discord](/docs/integrations/discord) channel.
    * Use an [LLM component](/docs/integrations/openrouter) to summarize a long customer email, then use that summary as the description when creating a Jira issue.
