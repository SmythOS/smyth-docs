...
<Image src="/docs/img/invite-member-popup.jpg" alt="Invite member modal in SmythOS" caption="Invite teammates with just their email and assign the right level of access." />
