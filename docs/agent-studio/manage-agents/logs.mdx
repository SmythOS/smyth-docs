...
- **Tags**, if triggered from the [Scheduler](/docs/agent-studio/build-agents/agent-tasks#scheduled-tasks)  
...
<InfoCallout>
For scheduled or bulk runs, follow the log link directly from the [Agent Tasks](/docs/agent-studio/build-agents/agent-tasks) tab.
</InfoCallout>
