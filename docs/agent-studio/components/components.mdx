...
- [Logic Gate](/docs/agent-studio/components/base/logic-gate)  
- [Code](/docs/agent-studio/components/advanced/code)
...
- Explore the **[Workflow Guide](/docs/build-agents/workflows)** to see how components come together  
