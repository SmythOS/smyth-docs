...
<Image src="/img/lead_contacts_scraper/Image 1.png" alt="alt text" />

4. Copy your API key using the `copy` icon. You can also click the eye icon to see your API key.

<Image src="/img/lead_contacts_scraper/Image 2.png" alt="alt text" />
...
<Image src="/img/lead_contacts_scraper/Image 3.png" alt="alt text" />
...
<Image src="/img/lead_contacts_scraper/Image 4.png" alt="alt text" />

7. Click the `Subscribe` button.

<Image src="/img/lead_contacts_scraper/Image 5.png" alt="alt text" />

8. Subscription created successfully.

<Image src="/img/lead_contacts_scraper/Image 6.png" alt="alt text" />

## Lead Scraper Agent Setup

1. Go to your SmythOS Dashboard and click on the `Create Agent` button.

<Image src="/img/lead_contacts_scraper/Image 7.png" alt="alt text" />

2. The template for the `Lead Contacts Scraper` is readily available. Simply select it from the drop-down menu.

<Image src="/img/lead_contacts_scraper/Image 8.png" alt="alt text" />

3. Click `Create` and allow the template to initialize and configure.

<Image src="/img/lead_contacts_scraper/Image 9.png" alt="alt text" />
...
<Image src="/img/lead_contacts_scraper/Image 16.png" alt="alt text" />
...
<Image src="/img/lead_contacts_scraper/Image 17.png" alt="alt text" />
...
<Image src="/img/lead_contacts_scraper/Image 18.png" alt="alt text" />
...
<Image src="/img/lead_contacts_scraper/Image 19.png" alt="alt text" />
