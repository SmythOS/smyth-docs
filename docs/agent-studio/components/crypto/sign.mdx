...
- Use this component to generate a signature for an outgoing **[API Call](/docs/agent-studio/components/base/api-call)**, adding the signature to the request headers.
