...
* **Explore Other Integrations:**
    * When a card is moved to the "Done" list on Trello (detected via webhook), trigger an agent to send a completion notification to a [Slack](/docs/agent-studio/integrations/slack-integration) or [Discord](/docs/integrations/discord) channel.
