...
* **Explore Other Integrations:**
    ...
    * Keep a log of all published articles by having your agent write the `blogId` and `blogUrl` to a [Google Sheet](/docs/agent-studio/integrations/google-sheets-integration) or [Notion](/docs/integrations/notion) database.
