...
og:image: /img/integrations/smythos_openapi.png
...
* **Build an Agent That...**
    ...
    * Connects to a translation service (via its OpenAPI spec) to translate text, and then uses the [Elevenlabs Integration](/docs/agent-studio/integrations/elevenlabs-integrationns/elevenlabs-integration) to read the translation aloud.
