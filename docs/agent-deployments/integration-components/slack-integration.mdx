...
<InfoCallout> **TL;DR:** Authenticate your Slack app, configure the Send Message component, or deploy using [Model Context Protocol (MCP)](/docs/agent-deployments/deployments/deploy-as-mcp) to route intelligent agent outputs into Slack. </InfoCallout>
