...
<Youtube videoId="V_YQWPFyga8" title="GenAI LLM Inputs | SmythOS" />
...
<Youtube videoId="XA-_vDe2taY" title="GenAI LLM Settings | SmythOS" />
...
<InfoCallout title="What is unique in Smythos">
