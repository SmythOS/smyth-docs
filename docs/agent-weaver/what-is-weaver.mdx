...
> It’s where prompt meets agent... and your typing becomes *Smyth-ing*.
...
While **Studio** gives you a classic drag-and-drop canvas for building agents manually, **Weaver starts with natural conversation.**
...
## Who Uses Weaver? (Hint: Probably You Soon)
