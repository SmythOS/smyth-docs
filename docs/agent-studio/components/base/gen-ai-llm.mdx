...
- Combine **GenAI LLM** with **[Agent Skill](../base/agent-skill)** to let users submit prompts naturally
- Pipe GenAI output into **[RAG Remember](../rag-data/rag-remember)** to store facts for reuse
- Use **[Code Component](../advanced/code)** downstream to transform, filter, or validate replies
