...
* **Build an Agent That...**
    ...
    * Generates a weekly "Top 5 AI News" summary using an [LLM component](/docs/agent-studio/integrations/openrouter-integration) and a [search tool](/docs/integrations/tavily), then publishes the summary as a blog post.
