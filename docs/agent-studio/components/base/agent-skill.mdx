...
- [Core Skill Definition](#step-1-define-the-skills-core-details)
- [Input Parameters](#step-2-define-input-parameters)
- [Advanced Options](#step-3-configure-advanced-options)
- [Outputs](#step-4-understand-the-outputs)
...
- Connect an **[LLM Assistant Component](./llm-assistant)** to your agent and have it use the skills you've built based on natural language commands.
- Create a "main" workflow that uses an **[Agent Skill Component](../base/agent-skill)** to call other, more specialized skills, creating a modular architecture.
- Use the **[API Output Component](../base/api-output)** at the end of a skill to define a standardized JSON response, especially if you have enabled Advanced Request Parts.
