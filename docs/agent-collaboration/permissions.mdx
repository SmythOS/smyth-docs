...
See the [Add or Remove Users](/docs/agent-collaboration/add-or-remove-users) guide for step-by-step instructions.
</TipCallout>
...
<Image src="/static/docs/img/docs/organization-create-role.jpg" alt="Create a role with custom permissions" caption="You can fully customize access for any role." />
...
- [Add or remove users in Studio or dashboard](/docs/agent-collaboration/add-or-remove-users)
