...
* **Explore Other Integrations:**
    * When a task is updated to "In Review" in ClickUp, trigger an agent to send a notification to a [Microsoft Teams](/docs/agent-studio/integrationsmicrosoft-teams-integration) channel.
