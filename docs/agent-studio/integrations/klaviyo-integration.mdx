...
* **Explore Other Integrations:**
    ...
    * Use data from [Stripe](/docs/integrations/stripe-integration) to segment customers. When a customer's subscription value exceeds a certain threshold, add them to a high-value customer list.
