...
og:image: /docs/img/integrations/smythos_microsoft_.png
...
<Image src="/docs/img/microsoft_calendar/screenshot1.png" alt="Microsoft Calendar Authentication Settings in SmythOS" />
...
<Image src="/docs/img/microsoft_calendar/screenshot2.png" alt="Inputs for Create Calendar component" />
...
<Image src="/docs/img/microsoft_calendar/screenshot3.png" alt="Outputs for Create Calendar component" />
...
<Image src="/docs/img/microsoft_calendar/screenshot4.png" alt="Body input for Update Calendar component" />
...
<Image src="/docs/img/microsoft_calendar/screenshot5.png" alt="Inputs for Update Calendar component" />
...
<Image src="/docs/img/microsoft_calendar/screenshot6.png" alt="Outputs for Update Calendar component" />
...
#### Settings
(Refer to the "Settings" section under [Create Calendar](#create-calendar) for details on Client ID/Secret and authentication.)
<Image src="/docs/img/microsoft_calendar/screenshot7.png" alt="Microsoft Calendar Authentication Settings in SmythOS" />
...
<Image src="/docs/img/microsoft_calendar/screenshot8.png" alt="Inputs for Delete Calendar component" />
...
<Image src="/docs/img/microsoft_calendar/screenshot9.png" alt="Outputs for Delete Calendar component" />
...
<Image src="/docs/img/microsoft_calendar/screenshot10.png" alt="Body input for Create Event component" />
...
<Image src="/docs/img/microsoft_calendar/screenshot11.png" alt="Inputs for Create Event component" />
...
<Image src="/docs/img/microsoft_calendar/screenshot12.png" alt="Outputs for Create Event component" />
...
#### Settings
(Refer to the "Settings" section under [Create Calendar](#create-calendar) for details on Client ID/Secret and authentication.)
<Image src="/docs/img/microsoft_calendar/screenshot13.png" alt="Microsoft Calendar Authentication Settings in SmythOS" />
_Image: Authentication settings, similar for all components._
...
<Image src="/docs/img/microsoft_calendar/screenshot14.png" alt="Inputs for List Events component" />
...
<Image src="/docs/img/microsoft_calendar/screenshot15.png" alt="Outputs for List Events component" />
