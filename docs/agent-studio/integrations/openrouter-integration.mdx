...
* **Explore Other Integrations:**
    ...
    * Generate text with an OpenRouter model and then give it a voice using the [Elevenlabs Integration](/docs/agent-studio/integrations/elevenlabs-integrationns).
