...
* **Build an Agent That...**
    ...
    * Sends a daily summary report. The agent gathers data from various sources ([Google Analytics](/docs/agent-studio/integrations/google-analytics), internal databases), formats it into an HTML report, and emails it to stakeholders.
