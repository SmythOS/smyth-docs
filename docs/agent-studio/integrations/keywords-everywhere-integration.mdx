...
og:image: /img/integrations/smythos_keywords_everywhere.png
...
* **Explore Other Integrations:**
    * Combine keyword data with SERP data from the [DataForSEO Integration](/docs/integrations/dataforseo) to get a complete picture of the search landscape.
    * Use the metrics to inform content briefs generated by AI components.
    * Log historical keyword volume changes in the [Google Sheets Integration](/docs/integrations/google-sheets) to track seasonality and trends.