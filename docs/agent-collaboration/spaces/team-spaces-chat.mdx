...
<Image src="/docs/img/agent_collaboration/team-chat-agent-card.png" alt="Agent card with Chat button on Team Dashboard" caption="Click the Chat button to start interacting with any deployed agent in your space."/>
...
- [Understand Roles & Access](/docs/account-management/user-management)
