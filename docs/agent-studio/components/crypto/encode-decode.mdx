...
- Take the output from an **[Image Generator](/docs/agent-studio/components/base/image-generator)**, `base64` encode it, and send it as part of a JSON payload in an **[API Call](/docs/agent-studio/components/base/api-call)**.
