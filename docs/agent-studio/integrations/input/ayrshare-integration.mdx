...
og:image: /img/integrations/smythos_ayrshare.png
...
* **Build an Agent That...**
    * Creates a "content machine." It uses an AI model from [OpenRouter](/docs/integrations/openrouter) to write a short social media tip, generates a relevant background image with [Stability AI](/docs/integrations/stability-ai), and posts the final image and text to Instagram and LinkedIn.
...
* **Explore Other Integrations:**
    * Use the [Google Sheets Integration](/docs/integrations/google-sheets) to create a simple content calendar. Your agent can read rows from the sheet daily and post the content via Ayrshare.
    * Connect to [Ahrefs](/docs/integrations/ahrefs) or another SEO tool. When your website earns a new, high-quality backlink, post a "Thank You" message mentioning the linking site on Twitter.
