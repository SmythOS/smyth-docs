...
When Custom Storage is enabled, all indexing operations from your [Data Spaces](../agent-collaboration/working-with-agents/data-spaces) write directly to the external vector store. SmythOS fetches context from there during retrieval-augmented generation (RAG).
...
<Image src="/static/docs/img/docs/pinecone-config-popup.jpg" alt="Custom Storage configuration form in SmythOS" caption="Paste your Pinecone credentials and save to activate external storage." />
...
- [Data Pool overview](../../data-pool)
- [Create and manage Data Spaces](../agent-collaboration/working-with-agents/data-spaces)
- [Connect data to agents](../agent-collaboration/working-with-agents/project-spaces)
- [Monitor usage in Analytics](../../analytics/overview)
