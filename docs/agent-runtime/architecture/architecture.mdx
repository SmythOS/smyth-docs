---
title: SRE architecture and subsystems
...
# SRE architecture and subsystems
...
SRE includes over 40 production-ready components grouped by function:

### AI & LLM components

- `GenAILLM` — multi-provider language model integration  
- `VisionLLM` — image analysis  
- `MultimodalLLM` — text, audio, image processing  
- `LLMAssistant` — conversational AI assistant  
- `HuggingFace` — Hugging Face model support  
...
- `ZapierAction` — automation triggers  
...
- `APIEndpoint` — custom API creation  

Keeping subsystems clear and components organized lets you scale your agents from prototype to production — without the usual runtime headaches.
