...
og:image: /img/integrations/smythos_google_chat.png
...
* **Explore Other Integrations:**
    * Combine Google Chat with the [Google Sheets Integration](/docs/integrations/google-sheets). An agent can read tasks from a sheet and send reminders to the assigned person in a direct message.
    * Use an [LLM component](/docs/integrations/openrouter) to summarize a long document, then post the summary to a Google Chat space for quick consumption by the team.
