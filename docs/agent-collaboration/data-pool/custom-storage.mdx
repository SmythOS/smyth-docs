...
<Image src="/docs/img/pinecone-config-popup.jpg" alt="Custom Storage configuration form in SmythOS" caption="Paste your Pinecone credentials and save to activate external storage." />
