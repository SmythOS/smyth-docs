...
### Step 1: Add the Domain in SmythOS
...
### Step 4: Deploy Agent to the Domain
...
- Set up domain-specific analytics and [monitor usage logs](/docs/agent-studio/agent-settings/logs)
