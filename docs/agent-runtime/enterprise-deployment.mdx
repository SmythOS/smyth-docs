...
description: Configure and deploy the SmythOS Runtime Environment for production using custom connectors and secure infrastructure.
...
The **SmythOS Runtime Environment (SRE)** supports enterprise-scale workloads. You can deploy SRE to any environment you control by supplying your own connectors for caching, storage, secrets, and logging.
...
- Apply [Roles and Permissions](/docs/account-management/user-management) for fine-grained runtime control
