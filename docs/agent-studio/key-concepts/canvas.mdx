...
1. **Drag components** from the library on the left onto the canvas.
...
<InfoCallout title="Component Library">
You have access to 40+ production-ready components including LLMs, APIs, RAG tools, and logic handlers. Learn more in the [Components Overview](/docs/sre/components-overview).
</InfoCallout>
...
1. Click [**Deploy**](/docs/agent-deployment/overview) in the top-right.
...
This lets you develop freely without affecting live agents.

### Version Control Features

- Track deployments and notes in **Deployment History**
- Roll back to any stable version with one click
- Keep multiple drafts in progress at once
...
<InfoCallout title="Need Logs?">
Visit [Agent Logs](/docs/agent-studio/manage-agents/logs) for deeper visibility into executions.
</InfoCallout>
...
- [How to Deploy Agents](/docs/agent-deployments/overview)
