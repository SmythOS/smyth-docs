...
- A dialog will show your **Client ID** and give you the option to download a JSON file.  
- To view your **Client Secret**, open the client details page.  
...
1. In your SmythOS dashboard, go to **Integrations**.  
2. Find **Gmail** and click **Add / Configure**.  
3. Paste in the **Client ID** and **Client Secret** you copied from Google Cloud.  
4. Click **Authenticate**.  
5. A **Google Sign-In** window opens:  
   - Log in with the Gmail account you’re connecting  
   - Review the requested permissions  
   - Click **Allow**  
6. You’ll return to SmythOS, and the integration will confirm connection.
