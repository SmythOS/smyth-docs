...
* **Explore Other Integrations:**
    ...
    * Use the `Extract` component to get clean article text and then pass it to the [PlayHT](/docs/integrations/playht) or [Elevenlabs](/docs/agent-studio/integrations/elevenlabs-integration) integrations to create an audio version.
