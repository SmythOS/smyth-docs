...
2. In your `Zendesk dashboard`, click on the Bento icon located in the upper right corner of the page.
 ...
 <Image src="/img/zendesk_leads_manager/Image 1.png" alt="alt text" /> 

3. Click `Sell` from the drop-down menu.

 <Image src="/img/zendesk_leads_manager/Image 2.png" alt="alt text" /> 

4. On the left sidebar, click the gear icon to access the settings.

 <Image src="/img/zendesk_leads_manager/Image 3.png" alt="alt text" /> 

5. Scroll down to the Integrations section, then click on OAuth.

 <Image src="/img/zendesk_leads_manager/Image 4.png" alt="alt text" /> 

6. Click the `Add Access Token` button to generate your personal access token.

 <Image src="/img/zendesk_leads_manager/Image 5.png" alt="alt text" /> 

7. For easy identification, add a description to your API Token, then save.

 <Image src="/img/zendesk_leads_manager/Image 6.png" alt="alt text" /> 
...
8. Remember to copy and securely store your generated token as it will not be displayed again after clicking the `Save` button.
 ...
 <Image src="/img/zendesk_leads_manager/Image 7.png" alt="alt text" /> 

## Agent Setup

1. In `SmythOS`, navigate to the templates tab.

 <Image src="/img/zendesk_leads_manager/Image 8.png" alt="alt text" /> 
...
2. You can scroll down to find the `Zendesk Leads Manager` Agent or simply search for it in the Search tab, then click the `Remix` button.
 ...
 <Image src="/img/zendesk_leads_manager/Image 9.png" alt="alt text" /> 
...
1. Look for the Zendesk Personal Token component.
 ...
 <Image src="/img/zendesk_leads_manager/Image 10.png" alt="alt text" /> 
...
2. Click on the gear icon to open the settings, then input your Zendesk Token in the Prompt. Remember to click the check mark to save your configuration.
 ...
 <Image src="/img/zendesk_leads_manager/Image 11.png" alt="alt text" /> 
...
1. Open the ChatBot embodiment and click on the chat icon.
 ...
 <Image src="/img/zendesk_leads_manager/Image 12.png" alt="alt text" /> 
### Create a Lead

1. Ask the agent to create a lead.

 <Image src="/img/zendesk_leads_manager/Image 13.png" alt="alt text" /> 

2. The agent will then ask for the following information.

 <Image src="/img/zendesk_leads_manager/Image 14.png" alt="alt text" /> 
...
4. The agent has successfully created the lead.
 ...
 <Image src="/img/zendesk_leads_manager/Image 15.png" alt="alt text" /> 

5. Now, let's verify your Zendesk dashboard to confirm the creation of the new lead.

 <Image src="/img/zendesk_leads_manager/Image 16.png" alt="alt text" /> 

### Retrieve a Single Lead

1. Ask the agent to retrieve a single lead.

 <Image src="/img/zendesk_leads_manager/Image 17.png" alt="alt text" /> 
...
3. Here’s the result!
 ...
 <Image src="/img/zendesk_leads_manager/Image 18.png" alt="alt text" /> 

### Retrieve all Leads

1. Ask the agent to retrieve all leads. Currently, we have 4 leads in our sample account.

 <Image src="/img/zendesk_leads_manager/Image 19.png" alt="alt text" /> 
2. Here’s the result!

 <Image src="/img/zendesk_leads_manager/Image 20.png" alt="alt text" /> 

 <Image src="/img/zendesk_leads_manager/Image 21.png" alt="alt text" />

 <Image src="/img/zendesk_leads_manager/Image 22.png" alt="alt text" /> 

 <Image src="/img/zendesk_leads_manager/Image 23.png" alt="alt text" /> 
### Update a Lead

1. Ask the agent to update a lead.

 <Image src="/img/zendesk_leads_manager/Image 24.png" alt="alt text" /> 
...
3. Here’s the result!
 ...
 <Image src="/img/zendesk_leads_manager/Image 25.png" alt="alt text" /> 
 
4. Now, let's check your Zendesk dashboard to confirm the update of Johnson's account.

 <Image src="/img/zendesk_leads_manager/Image 26.png" alt="alt text" /> 

### Delete a Lead

1. Ask the agent to delete a lead.

 <Image src="/img/zendesk_leads_manager/Image 27.png" alt="alt text" /> 

2. For instance, let’s delete `Smith - Evergreen Solutions - ID: 2190326053`

 <Image src="/img/zendesk_leads_manager/Image 28.png" alt="alt text" /> 

3. Here’s the result!

 <Image src="/img/zendesk_leads_manager/Image 29.png" alt="alt text" /> 