...
1. Open Notion Settings & members → Connections. Click Develop or manage integrations.

2. Click New integration. Enter a name, pick your workspace, set Type to Internal, optionally add a logo. Click Save.

3. Click Configure integration settings.

4. On the Configuration tab, click Show for Internal Integration Secret and copy it. Store it securely as an environment variable or in a secrets manager. Use Refresh to rotate if needed. This is the key you'll use in SmythOS.

5. Open the Access tab. Click Select pages, choose the pages or databases your bot needs, then Update access.

<Image src="/docs/img/notion/notion-secret.png" alt="Finding the Notion Integration Secret" />
...
<Youtube videoId="6kgZWE9L9_E" title="Notion List Users" />
...
<Youtube videoId="AykwYzXiB5w" title="Notion Create Comment" />
...
<Youtube videoId="e0EuRWMf2nk" title="Notion Create Page" />
...
<Youtube videoId="r9t2wJHmcUY" title="Notion Fetch Page" />
...
<Youtube videoId="ixkVZKbr4pA" title="Notion Retrieve Database" />
...
<Youtube videoId="1Lu7Ea6_Ii8" title="Notion Create Database" />
...
<Youtube videoId="WzzMqiB5-AQ" title="Notion Retrieve Comments" />
...
<Youtube videoId="gvYelKkqQxs" title="Notion Query Database" />
...
<Youtube videoId="A-nOz_KAw3g" title="Notion Update Database" />
...
<Youtube videoId="hFFZBYoXsoc" title="Notion Search Title" />
