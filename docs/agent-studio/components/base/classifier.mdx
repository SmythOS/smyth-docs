...
- Combine with **[Agent Skill](../base/agent-skill)** to classify natural user queries
- Store classifications in **[RAG Remember](../rag-data/rag-remember)** to build memory or logs
