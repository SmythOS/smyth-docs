...
* **Explore Other Integrations:**
    ...
    * Generate text with an OpenRouter model and then give it a voice using the [Elevenlabs Integration](/docs/agent-studio/integrations/elevenlabs-integrationns/elevenlabs-integration).
    * Use OpenRouter to process data before logging it to a [Google Sheet](/docs/agent-studio/integrations/google-sheets-integration) or sending it as an [Email](/docs/integrations/email).
