...
The SmythOS Runtime Environment (SRE) is designed with security at its core. Every operation, agent execution, resource access, or collaboration, is protected by a security model that includes zero-trust access control, vault-backed secret management, and real-time role enforcement.
...
You can manage these permissions through [Roles and Permissions](/docs/account-management/user-management), and they are enforced consistently across [Spaces](/docs/agent-collaboration/spaces) and your [Organization](/docs/account-management/organization-management).
...
To adjust or review roles, see the [Roles and Permissions guide](/docs/account-management/user-management).
...
|-------------------------|-------------------------------------------------------------|
| Identity & ACLs         | [Roles and Permissions](/docs/account-management/user-management) |
...
- [Roles and Permissions](/docs/account-management/user-management)
