...
- Optionally, [Vault access](/docs/agent-collaboration/working-with-agents/vault) for securely storing tokens
...
4. Optionally store it in [Vault → API Keys](/docs/agent-collaboration/working-with-agents/vault)
