...
<InfoCallout title="TL;DR">  Export your agent's test or production endpoints as a Postman collection, or drag and drop an existing Postman collection into Builder to auto-generate agent components. </InfoCallout>
...
<Youtube videoId="sLPyzxqCsvw" title="Export Agent to Postman | SmythOS" />
...
<Youtube videoId="IVZZ3wtOUfc" title="Import Postman Collection | SmythOS" />
