...
- Connect this to the output of an **[API Call Component](../../base/api-call)** to perform a custom transformation on the response data that is too complex for a simple filter.
