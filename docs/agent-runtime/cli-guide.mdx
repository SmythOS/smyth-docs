...
The SmythOS CLI puts powerful agent management at your fingertips. With the CLI, you can automate project setup, run and test agents, manage builds, and bridge visual (Studio) and code-first (SDK) workflows—all from your terminal.
