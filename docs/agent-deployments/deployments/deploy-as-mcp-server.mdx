...
## Why Use the Model Context Protocol (MCP)?
...
## Step-by-Step: Enable and Use MCP
...
<WarningCallout>
If your SmythOS agent uses [OAuth](/docs/agent-studio/agent-settings/authentication) or other authentication layers, it will reject unauthenticated MCP requests.
</WarningCallout>
