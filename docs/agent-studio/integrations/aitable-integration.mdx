...
og:image: /img/integrations/smythos_aitable.png
...
<Image src="/img/integrations/aitable_token.png" alt="AITable Token Configuration" />
...
- [PDF Generator](/docs/agent-studio/components/convert/pdf-generator) to save tabular data as branded reports  
- [Google Sheets Integration](/docs/agent-studio/integrations/output/google-sheets-integration) for spreadsheet-to-datasheet syncing  
- [Email Attachment Parser](/docs/agent-studio/components/utility/email-parser) to extract table content from incoming files  
- [Google Drive Integration](/docs/agent-studio/integrations/input/google-drive-integration) for working with uploaded sheets or templates

<Image src="/img/integrations/smythos_aitable.png" alt="AITable Integration Overview" />
