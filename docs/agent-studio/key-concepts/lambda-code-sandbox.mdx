...
Use the [**Logs**](/docs/agent-studio/manage-agents/log) tab on the component to monitor:
...
Logs can be viewed in the Studio Canvas or on the [Agent Dashboard](app.smythos.com/agents) in the sidebar.
</InfoCallout>
...
- [API Call Component](../agent-components)
