...
- **[GenAI LLM](../components/base/genai-llm)** – Summarize or explain the parsed data.  
- **[RAG Remember](../components/rag-data/rag-remember)** – Store records for later retrieval.  
- **[Another Code Component](../components/advanced/code)** – Perform further calculations or validations.
...
- Feed your JSON output into **[GenAI LLM](../components/base/genai-llm)** for human-readable summaries or analysis.  
- Use **[RAG Remember](../components/rag-data/rag-remember)** to store parsed records for future queries.  
- Wrap this component in an **[Agent Skill](../skills/base/agent-skill)** to make it a reusable action for end users.  
