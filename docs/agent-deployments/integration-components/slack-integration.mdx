...
- Optional: Store the token in [Vault → API Keys](/docs/agent-collaboration/working-with-agents/vault)
...
- Use [Vault](/docs/agent-collaboration/working-with-agents/vault) to manage tokens securely
