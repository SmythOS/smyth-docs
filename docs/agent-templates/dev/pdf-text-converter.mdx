...
<Image src="/img/pdf_text_converter_agent/Image 1.png" alt="alt text" />

3. Then, copy your Username and API key and store in a secure location.

<Image src="/img/pdf_text_converter_agent/Image 2.png" alt="alt text" />

## Agent Setup

1. In `SmythOS`, navigate to the `Templates` tab.

<Image src="/img/pdf_text_converter_agent/Image 3.png" alt="alt text" />
...
<Image src="/img/pdf_text_converter_agent/Image 4.png" alt="alt text" />
...
<Image src="/img/pdf_text_converter_agent/Image 5.png" alt="alt text" />
...
<Image src="/img/pdf_text_converter_agent/Image 6.png" alt="alt text" />
...
<Image src="/img/pdf_text_converter_agent/Image 7.png" alt="alt text" />

2. Prepare a PDF file for conversion into a text file and ask the agent to convert it.
   1. **Sample PDF file:** *https://clickdimensions.com/links/TestPDFfile.pdf*
   2. **Content:** This is a test PDF file.

<Image src="/img/pdf_text_converter_agent/Image 8.png" alt="alt text" />

3. Here’s the result!

<Image src="/img/pdf_text_converter_agent/Image 9.png" alt="alt text" />
