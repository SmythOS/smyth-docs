...
* **Explore Other Integrations:**
    ...
    * Connect GoHighLevel to a payment processor like [Stripe](/docs/integrations/stripe). When a new customer is created in Stripe, create or update the corresponding contact in GoHighLevel.
