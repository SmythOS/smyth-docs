...
<InfoCallout>
You can test this webhook first using [Postman](https://www.postman.com/) - [we also have a guide on how](/docs/agent-deployments/deployments/use-postman) - or `curl` to ensure it responds correctly before adding it to Siri.
</InfoCallout>
...
- [Log all invocations](/docs/agent-studio/agent-settings/logs) in SmythOS to track Siri activity  
