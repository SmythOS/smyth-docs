...
<Image src="/img/inventory/Image 1.png" alt="alt text" /> 
...
<Image src="/img/inventory/Image 2.png" alt="alt text" /> 
...
<Image src="/img/inventory/Image 3.png" alt="alt text" /> 
...
<Image src="/img/inventory/Image 4.png" alt="alt text" /> 
...
<Image src="/img/inventory/Image 5.png" alt="alt text" />
...
<Image src="/img/inventory/Image 39.png" alt="alt text" />

2. Click `Import Customers`.

<Image src="/img/inventory/Image 40.png" alt="alt text" />

3. You can drag and drop your CSV file or click to select a file.

<Image src="/img/inventory/Image 41.png" alt="alt text" />

4. Once your file is ready, click `next` to proceed.

<Image src="/img/inventory/Image 42.png" alt="alt text" />

5. Then, click `Import`.

<Image src="/img/inventory/Image 43.png" alt="alt text" />

6. Once the import process is successful, InFlow will notify you via email.

<Image src="/img/inventory/Image 44.png" alt="alt text" />
...
<Image src="/img/inventory/Image 45.png" alt="alt text" />

2. Click `Import Vendors`.

<Image src="/img/inventory/Image 46.png" alt="alt text" />

3. You can drag and drop your CSV file or click to select a file.

<Image src="/img/inventory/Image 47.png" alt="alt text" />

4. Once your file is ready, click `next` to proceed.

<Image src="/img/inventory/Image 48.png" alt="alt text" />

5. Then, click `Import`.

<Image src="/img/inventory/Image 49.png" alt="alt text" />

6. Once the import process is successful, InFlow will notify you via email.

<Image src="/img/inventory/Image 50.png" alt="alt text" />
...
<Image src="/img/inventory/Image 51.png" alt="alt text" />

2. Click `Import Products`.

<Image src="/img/inventory/Image 52.png" alt="alt text" />

3. You can drag and drop your CSV file or click to select a file.

<Image src="/img/inventory/Image 53.png" alt="alt text" />

4. Once your file is ready, click `next` to proceed.

<Image src="/img/inventory/Image 54.png" alt="alt text" />

5. Then, click `Import`.

<Image src="/img/inventory/Image 55.png" alt="alt text" />

6. Once the import process is successful, InFlow will notify you via email.

<Image src="/img/inventory/Image 56.png" alt="alt text" />

## InFlow Inventory Template Setup

1. Go to your SmythOS Dashboard and click on the Create Agent button.

<Image src="/img/inventory/Image 6.png" alt="alt text" />
...
<Image src="/img/inventory/Image 7.png" alt="alt text" />
...
<Image src="/img/inventory/Image 8.png" alt="alt text" />
...
<Image src="/img/inventory/Image 9.png" alt="alt text" />

2. Click the `Add Key` button to add your InFlow API Key.

<Image src="/img/inventory/Image 10.png" alt="alt text" />
...
<Image src="/img/inventory/Image 15.png" alt="alt text" />
...
<Image src="/img/inventory/Image 16.png" alt="alt text" />
...
<Image src="/img/inventory/Image 17.png" alt="alt text" />

4. When you successfully configure your API Call component, the error message will disappear.

<Image src="/img/inventory/Image 18.png" alt="alt text" />
...
<Image src="/img/inventory/Image 19.png" alt="alt text" />

3. Ask the agent to get a category list.

<Image src="/img/inventory/Image 20.png" alt="alt text" />

4. The agent will now furnish you with the product categories in your InFlow inventory.

<Image src="/img/inventory/Image 21.png" alt="alt text" />

### Get Customer List

1. Ask the agent to retrieve the list of customers.

<Image src="/img/inventory/Image 22.png" alt="alt text" />
...
<Image src="/img/inventory/Image 23.png" alt="alt text" />

3. You can also view the full list of the customers with the link provided by the Agent.

<Image src="/img/inventory/Image 24.png" alt="alt text" />

### Get Customer Details

1. Ask the agent to get some customer details.

<Image src="/img/inventory/Image 25.png" alt="alt text" />
...
<Image src="/img/inventory/Image 26.png" alt="alt text" />
...
<Image src="/img/inventory/Image 27.png" alt="alt text" />

### Add new products to the inventory

1. Instruct the agent that you wish to add a product to the inventory.

<Image src="/img/inventory/Image 28.png" alt="alt text" />
...
<Image src="/img/inventory/Image 29.png" alt="alt text" />
...
<Image src="/img/inventory/Image 30.png" alt="alt text" />
...
<Image src="/img/inventory/Image 36.png" alt="alt text" />

<Image src="/img/inventory/Image 37.png" alt="alt text" />
...
<Image src="/img/inventory/Image 38.png" alt="alt text" />
