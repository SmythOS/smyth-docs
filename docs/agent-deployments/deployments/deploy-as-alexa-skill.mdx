...
## Step 1: Copy the Alexa Endpoint
...
## Step 3: Add the SmythOS Endpoint
...
## Step 4: Configure the Invocation Name
...
- Track usage inside SmythOS Agent Settings → **[Logs](/docs/agent-studio/agent-settings/logs)**
