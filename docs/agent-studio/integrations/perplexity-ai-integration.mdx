...
* **Explore Other Integrations:**
    * Combine Perplexity AI with a text-to-speech service like [Elevenlabs](/docs/agent-studio/integrations/elevenlabs-integrations) to create an audio news briefing.
