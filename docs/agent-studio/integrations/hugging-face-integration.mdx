...
og:image: /img/integrations/smythos_huggingface.png
...
* **Explore Other Integrations:**
    * Combine Hugging Face with the [ScrapingBee Integration](/docs/integrations/scrapingbee) to scrape text from a web page and feed it into any NLP model.
    * Use the results from a Hugging Face model to trigger actions in [Slack](/docs/integrations/slack), [Email](/docs/integrations/email), or by updating a record in a CRM.
    * Generate text with a Hugging Face model and then give it a voice using the [Elevenlabs Integration](/docs/integrations/elevenlabs).
