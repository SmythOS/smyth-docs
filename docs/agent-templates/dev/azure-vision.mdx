...
<Image src="/img/azure_vision_agent/Image 1.png" alt="alt text" />

4. Copy your API key using the `copy` icon. You can also click the eye icon to see your API key.

<Image src="/img/azure_vision_agent/Image 2.png" alt="alt text" />
...
<Image src="/img/azure_vision_agent/Image 3.png" alt="alt text" />
...
<Image src="/img/azure_vision_agent/Image 4.png" alt="alt text" />

3. Click the `Subscribe` button.

<Image src="/img/azure_vision_agent/Image 5.png" alt="alt text" />
   
4. Subscription created successfully.

<Image src="/img/azure_vision_agent/Image 6.png" alt="alt text" />

## Azure Vision OCR Agent Setup

1. In SmythOS, go to `Templates` tab

<Image src="/img/azure_vision_agent/Image 7.png" alt="alt text" />

2. Find the `Azure OCR` Agent, hover over it, click the Remix button, and allow the template to initialize and configure.

<Image src="/img/azure_vision_agent/Image 8.png" alt="alt text" />

## LLM Prompt Setup

1. In `SmythOS`, locate the `LLM Prompt` component then click on the gear icon to access its settings.

<Image src="/img/azure_vision_agent/Image 9.png" alt="alt text" />
...
<Image src="/img/azure_vision_agent/Image 10.png" alt="alt text" />
...
<Image src="/img/azure_vision_agent/Image 11.png" alt="alt text" />
...
<Image src="/img/azure_vision_agent/Image 12.png" alt="alt text" />

4. Ask the agent to analyze your image.
   1. **Prompt:** Analyze this image https://i.stack.imgur.com/sFPWe.png

<Image src="/img/azure_vision_agent/Image 13.png" alt="alt text" />

5. Here’s the result!

<Image src="/img/azure_vision_agent/Image 14.png" alt="alt text" />
