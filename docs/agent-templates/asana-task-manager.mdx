...
<Image src="/img/asana_task_manager/1.png" alt="alt text" />

3. Navigate to `Apps` and click `Manage Developer Apps`.

<Image src="/img/asana_task_manager/2.png" alt="alt text" />

4. Click `Create New App`.

<Image src="/img/asana_task_manager/3.png" alt="alt text" />
...
<Image src="/img/asana_task_manager/4.png" alt="alt text" />
...
<Image src="/img/asana_task_manager/5.png" alt="alt text" />

7. Navigate to the left sidebar and click `OAuth` and click `Add Redirect URL`. 

<Image src="/img/asana_task_manager/6.png" alt="alt text" />
...
<Image src="/img/asana_task_manager/7.png" alt="alt text" />
...
<Image src="/img/asana_task_manager/8.png" alt="alt text" />

## Agent Setup

1. In SmythOS, navigate to the templates tab.

<Image src="/img/asana_task_manager/9.png" alt="alt text" />
...
<Image src="/img/asana_task_manager/10.png" alt="alt text" />
...
<Image src="/img/asana_task_manager/11.png" alt="alt text" />
...
<Image src="/img/asana_task_manager/12.png" alt="alt text" />
...
<Image src="/img/asana_task_manager/17.png" alt="alt text" />

2. Enter your Data Space name and click the `Add Data Space` button.

<Image src="/img/asana_task_manager/18.png" alt="alt text" />

3. Click on the Data Space you have created.

<Image src="/img/asana_task_manager/19.png" alt="alt text" />

4. Then, click `Add Source`.

<Image src="/img/asana_task_manager/20.png" alt="alt text" />
...
<Image src="/img/asana_task_manager/21.png" alt="alt text" />

6. Then, wait for your data source to be fully indexed.

<Image src="/img/asana_task_manager/22.png" alt="alt text" />
...
<Image src="/img/asana_task_manager/23.png" alt="alt text" />
