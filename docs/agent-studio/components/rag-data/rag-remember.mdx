...
- Pair this component with **[RAG Search](/docs/agent-studio/components/rag-data/rag-search)** and **[RAG Forget](./rag-forget)** to build a complete lifecycle for your agent's knowledge management.
