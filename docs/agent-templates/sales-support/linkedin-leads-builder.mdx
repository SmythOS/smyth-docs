...
<Image src="/img/linkedin_leads_builder/Image 1.png" alt="alt text" />
...
<Image src="/img/linkedin_leads_builder/Image 2.png" alt="alt text" />
...
<Image src="/img/linkedin_leads_builder/Image 3.png" alt="alt text" />

7. Click the `Subscribe` button.

<Image src="/img/linkedin_leads_builder/Image 4.png" alt="alt text" />

## Agent Setup

1. In `SmythOS`, navigate to the templates tab.

<Image src="/img/linkedin_leads_builder/Image 5.png" alt="alt text" />
...
<Image src="/img/linkedin_leads_builder/Image 6.png" alt="alt text" />
...
<Image src="/img/linkedin_leads_builder/Image 7.png" alt="alt text" />

2. Replace the `X-RapidAPI-Key` value on the API call header with your RapidAPI key. 

<Image src="/img/linkedin_leads_builder/Image 8.png" alt="alt text" />
...
<Image src="/img/linkedin_leads_builder/Image 9.png" alt="alt text" />

2. Replace the `X-RapidAPI-Key` value on the API call header with your RapidAPI key.

<Image src="/img/linkedin_leads_builder/Image 10.png" alt="alt text" />
