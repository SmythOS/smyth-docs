...
* **Explore Other Integrations:**
    ...
    * After adding a new member with this component, use the [Resend](/docs/agent-studio/integrations/resend-integration) or [SendGrid](/docs/integrations/sendgrid) integrations to send an immediate, custom transactional email if needed.
