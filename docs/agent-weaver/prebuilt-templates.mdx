...
> **Why start with an empty chat?** Use templates with Weaver to access dozens of ready-made workflows. Two clicks and you’re 80 % done.

<InfoCallout> **TL;DR:** Browse → Remix → Swap skills → Use as your own.  </InfoCallout>
