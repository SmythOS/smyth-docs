---
title: Architecture
description: Explore the modular, secure architecture of the SmythOS Runtime Environment and how its subsystems work together to power your AI agents.
...
<Image
  src="/docs/img/sre/sre-architecture.png"
  alt="SRE architecture diagram"/>
