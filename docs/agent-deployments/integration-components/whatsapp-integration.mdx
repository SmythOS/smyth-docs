...
5. **Generate Access Token** and store it in [Vault → API Keys](/docs/agent-collaboration/working-with-agents/vault)
...
2. **Copy your Account SID and Auth Token**, store in [Vault → API Keys](/docs/agent-collaboration/working-with-agents/vault)
...
- Use [Vault](/docs/agent-collaboration/working-with-agents/vault) to manage auth securely
