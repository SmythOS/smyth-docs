...
- Optionally configure [Vault → API Keys](/docs/agent-collaboration/working-with-agents/vault-sharing) for securely managing your Bot Token
...
<InfoCallout>
Keep your Bot Token secure in [Vault → API Keys](/docs/agent-collaboration/working-with-agents/vault-sharing).
</InfoCallout>
...
If your agent is deployed using [MCP Server](/docs/deployments/mcp-overview), you can:
...
- Log activity with [Agent Logs](/docs/agent-studio/agent-settings/logs)
