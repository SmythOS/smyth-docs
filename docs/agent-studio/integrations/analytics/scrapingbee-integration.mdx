...
og:image: /img/integrations/smythos_scrapingbee.png
...
* **Explore Other Integrations:**
    * Combine ScrapingBee with the [Google Sheets Integration](/docs/integrations/google-sheets) to store your scraped data in a structured format.
    * Use scraped data to fuel workflows with AI components for analysis, summarization, or classification.
    * Trigger [Email](/docs/integrations/email) or [Slack](/docs/integrations/slack) alerts based on changes detected in the data you scrape (e.g., a price drop).
