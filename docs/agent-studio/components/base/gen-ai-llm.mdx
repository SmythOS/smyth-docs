...
- Combine **GenAI LLM** with **[Agent Skill](../skills/base/agent-skill)** to let users submit prompts naturally
- Pipe GenAI output into **[RAG Remember](../components/rag-data/rag-remember)** to store facts for reuse
- Use **[Code Component](../components/advanced/code)** downstream to transform, filter, or validate replies
- Explore **[Output Recipes](/docs/patterns/structured-outputs)** for common JSON or Markdown use cases
