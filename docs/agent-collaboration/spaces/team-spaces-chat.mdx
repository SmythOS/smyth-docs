...
**Team Spaces Chat** lets anyone in your [space](./spaces/spaces) open a conversation with a deployed agent with no setup or special permissions. Everyone sees the same thread, enabling shared exploration and real-time collaboration.
...
<Image src="/static/docs/img/docs/team-chat-agent-card.jpg" alt="Agent card with Chat button on Team Dashboard" caption="Click the Chat button to start interacting with any deployed agent in your space."/>
...
1. Click your team name (top right)  
2. Select **Create space**  
3. Name it and click **Create**  
4. Invite members and assign roles  

<Image src="/static/docs/img/docs/create-space-flow.jpg" alt="Space creation flow in SmythOS" caption="Spaces group agents, team members, and shared tools in one place."/>
...
Store proven prompts in Notion, a doc, or within your [space](./spaces/spaces) documentation.
</TipCallout>

## What's Next?

- [Try Chat with Agent](../chat-with-agent)
- [Invite Members to a Space](./invite-members)
- [White Label Your Agent UI](./white-labeling)
- [Understand Roles & Access](../permissions)
