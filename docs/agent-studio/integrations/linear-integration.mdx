...
* **Explore Other Integrations:**
    * When a new issue is created in Linear, trigger an agent to create a corresponding channel in [Microsoft Teams](/docs/integrations/microsoft-teams-integration) or [Slack](/docs/agent-studio/integrations/slack-integration) for discussion.
