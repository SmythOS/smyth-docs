...
This component is exclusively available for Enterprise accounts. [Contact us](https://smythos.com/contact-us/) to get access.
</InfoCallout>
...
- Feed the raw `Output` into a **[GenAI LLM Component](../../base/gen-ai-llm)** to have it write a narrative summary of the structured data.
- Use this component as a more powerful alternative to the basic **[Web Search Component](./web-search)** for complex research tasks that require multiple steps.
- Use a **[JSON Filter Component](../advanced/json-filter)** to further refine or clean the structured `Output` before passing it to other parts of your workflow.
