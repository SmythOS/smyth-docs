...
<InfoCallout> You can log outputs using [Agent Logs](/docs/agent-studio/agent-settings/logs) for monitoring and debugging. </InfoCallout>
...
- Log all completions in [Agent Logs](/docs/agent-studio/agent-settings/logs)
