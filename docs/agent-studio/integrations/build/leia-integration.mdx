...
og:image: /img/integrations/smythos_leia.png
...
* **Explore Other Integrations:**
    * Use the [ScrapingBee Integration](/docs/integrations/scrapingbee) to find images on a website, then use Leia to convert them to 3D.
    * Generate an image with an AI model like [Fal.ai](/docs/integrations/fal-ai) and then bring it to life with Leia's animation tools.
    * Store your final animation files in [OneDrive](/docs/integrations/onedrive) or another cloud storage service for long-term keeping.
