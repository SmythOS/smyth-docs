...
> **Note:** By default, `OpenAI` models are available. Use your API key for full-length models. Additional models like `Claude` can be added. For setup, visit [API Key Management](/docs/agent-collaboration/working-with-agents/vault-sharing).
