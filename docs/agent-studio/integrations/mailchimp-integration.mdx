...
og:image: /img/integrations/smythos_mailchimp.png
...
* **Explore Other Integrations:**
    ...
    * After adding a new member with this component, use the [Resend](/docs/integrations/resend-integration) or [SendGrid](/docs/integrations/sendgrid) integrations to send an immediate, custom transactional email if needed.
    * Connect to a database integration like [Firestore](/docs/integrations/firestore-integration) to log every time a new subscriber is added for auditing purposes.
