...
- Use the **[Smyth SDK](/docs/sre/sdk-guide)** for full programmatic control.
- Combine both in [hybrid workflows](/docs/sre/hybrid-workflows) that balance visual design and code.
...
## Secure your agents
Security is baked into the runtime. The **[Security subsystem](/docs/sre/security)** manages sensitive credentials and permissions.
...
SRE includes 40+ production-ready [Components](/docs/sre/components) that accelerate your development.
...
For the full list, see the [Components Reference](/docs/sre/components) page.
</InfoCallout>

## What’s Next?
Explore more to master your AI agent’s runtime:

- **[Getting Started](/docs/sre/quickstart)**: Run your first agent.
- **[Building Agents](/docs/sre/building-agents)**: Create an agent from scratch.
- **[Smyth SDK Guide](/docs/sre/sdk-guide)**: Program your agents with the SDK.