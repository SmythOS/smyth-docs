...
* **Build an Agent That...**
    ...
    * Connects to a translation service (via its OpenAPI spec) to translate text, and then uses the [Elevenlabs Integration](/docs/agent-studio/integrations/elevenlabs-integrations) to read the translation aloud.
