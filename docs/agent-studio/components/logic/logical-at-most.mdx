...
keywords: [Logic, At Most, condition, boolean, true, false, maximum, limit]
...
- Use this component after a **[ForEach Loop](../advanced/for-each)** to check that at most a certain number of items in the list failed processing.
...
- Combine this with **[Logic At Least](./logic-at-least)** to check for a range, for example, "Verified if at least 2 AND at most 4 conditions are true."
