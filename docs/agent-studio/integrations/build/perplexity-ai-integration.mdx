...
og:image: /img/integrations/smythos_perplexity.png
...
|---------------|------------|------------------|------------|------------------|---------------|
| [**Chat Completion**](#chat-completion)| AI Task | Runs chat and text generation on various models, including web-connected ones. | <Badge type="required" /> `prompt`<br /><Badge type="optional" /> `model` | `message_content`| Research, fact-checking, content creation. |
...
* **Explore Other Integrations:**
    * Combine Perplexity AI with a text-to-speech service like [Elevenlabs](/docs/integrations/elevenlabs) to create an audio news briefing.
    * Use Perplexity to research a topic, then use the [Fal.ai Integration](/docs/integrations/fal-ai) to generate a relevant image for the content.
    * Feed the output from Perplexity into a [Google Sheet](/docs/integrations/google-sheets) to build a repository of sourced facts and research.
