...
<Image src="/img/transparent_image_maker/Image 1.png" alt="alt text" />

4. Click on `API Keys` on your dashboard, then click the `New API Key` button.

<Image src="/img/transparent_image_maker/Image 2.png" alt="alt text" />

5. Create a key label for easy identification of your API key, then click `Create API Key` button.

<Image src="/img/transparent_image_maker/Image 3.png" alt="alt text" />

6. Copy your API Key and click the `Save Changes` button.

<Image src="/img/transparent_image_maker/Image 4.png" alt="alt text" />

## Agent Setup

1. In `SmythOS`, navigate to the `Templates` tab.

<Image src="/img/transparent_image_maker/Image 5.png" alt="alt text" />
...
<Image src="/img/transparent_image_maker/Image 6.png" alt="alt text" />
...
<Image src="/img/transparent_image_maker/Image 7.png" alt="alt text" />

2. Click the `Add Key` button to add your `RemoveBG API Key`.

<Image src="/img/transparent_image_maker/Image 8.png" alt="alt text" />

3. Input the `RemoveBG API Key` generated from your RemoveBG account.

<Image src="/img/transparent_image_maker/Image 9.png" alt="alt text" />

4. Select a distinct Key name that you can readily differentiate whenever it is required for use.

<Image src="/img/transparent_image_maker/Image 10.png" alt="alt text" />

5. Choose `API Call` for the Scope and click `Done` to save your API Key.

<Image src="/img/transparent_image_maker/Image 11.png" alt="alt text" />

6. Your `RemoveBG API Key` has been successfully added to your `Vault` and is now ready for use.

<Image src="/img/transparent_image_maker/Image 12.png" alt="alt text" />
...
<Image src="/img/transparent_image_maker/Image 13.png" alt="alt text" />
...
<Image src="/img/transparent_image_maker/Image 14.png" alt="alt text" />
...
<Image src="/img/transparent_image_maker/Image 15.png" alt="alt text" />
...
<Image src="/img/transparent_image_maker/Image 16.png" alt="alt text" />

2. Open the debugger when testing via the chat embodiment to preview the generated image.

<Image src="/img/transparent_image_maker/Image 17.png" alt="alt text" />
...
<Image src="/img/transparent_image_maker/Image 18.png" alt="alt text" />

<Image src="/img/transparent_image_maker/Image 19.png" alt="alt text" />
...
<Image src="/img/transparent_image_maker/Image 20.png" alt="alt text" />

6. This is the preview image. You can also open it in a new tab.

<Image src="/img/transparent_image_maker/Image 21.png" alt="alt text" />

7. In the `Remove Background` component, you can check the preview of the image with the background removed.

<Image src="/img/transparent_image_maker/Image 22.png" alt="alt text" />

8. Here’s the preview.

<Image src="/img/transparent_image_maker/Image 23.png" alt="alt text" />

9. Background successfully removed. You can go to the preview or click the link to download the image.

<Image src="/img/transparent_image_maker/Image 24.png" alt="alt text" />