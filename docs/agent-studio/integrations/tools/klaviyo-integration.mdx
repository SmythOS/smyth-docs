...
og:image: /img/integrations/smythos_klaviyo.png
...
* **Explore Other Integrations:**
    * When a new user signs up in [Firebase](/docs/integrations/firebase), trigger an agent to add them to your "Welcome Series" list in Klaviyo.
    * Use data from [Stripe](/docs/integrations/stripe) to segment customers. When a customer's subscription value exceeds a certain threshold, add them to a high-value customer list.
