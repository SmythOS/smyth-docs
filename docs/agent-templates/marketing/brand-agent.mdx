...
import Image from '@site/src/components/Image';  // Assuming Image component path for Docusaurus/MDX
import Youtube from '@site/src/components/Youtube'; // Assuming Youtube component path for Docusaurus/MDX

---
title: Tutorial: Brand Agent
description: A comprehensive tutorial on setting up and testing a Brand Agent in SmythOS.
tags: [tutorial, agents, brand, SmythOS, workflow]
---
...
<Image
  src="/img/brand-agent/agentTemplate.png"
  alt="alt text"
  maxWidth={900}
...
<Image
  src="/img/brand-agent/createAgent.png"
  alt="alt text"
  maxWidth={900}
  imgStyle={{ border: '3px solid #3efcc2', borderRadius: '10px' }}
/>
...
<Image
  src="/img/brand-agent/apiEndpointDetails.png"
  alt="alt text"
  maxWidth={900}
  imgStyle={{ border: '3px solid #3efcc2', borderRadius: '10px' }}
/>
...
<Image
  src="/img/brand-agent/apiEndpointInputs.png"
  alt="alt text"
  maxWidth={900}
  imgStyle={{ border: '3px solid #3efcc2', borderRadius: '10px' }}
/>
...
<Image
  src="/img/brand-agent/apiEndpointOutputs.png"
  alt="alt text"
  maxWidth={900}
  imgStyle={{ border: '3px solid #3efcc2', borderRadius: '10px' }}
/>
...
<Image
  src="/img/brand-agent/dataLookupSettings.png"
  alt="alt text"
  maxWidth={900}
  imgStyle={{ border: '3px solid #3efcc2', borderRadius: '10px' }}
/>
...
<Image
  src="/img/brand-agent/classifierSettings.png"
  alt="alt text"
  maxWidth={900}
  imgStyle={{ border: '3px solid #3efcc2', borderRadius: '10px' }}
/>
...
<Image
  src="/img/brand-agent/classifierOutputs1.png"
  alt="alt text"
  maxWidth={900}
  imgStyle={{ border: '3px solid #3efcc2', borderRadius: '10px' }}
/>
...
<Image
  src="/img/brand-agent/classifierOutputs2.png"
  alt="alt text"
  maxWidth={900}
  imgStyle={{ border: '3px solid #3efcc2', borderRadius: '10px' }}
/>
...
<Image
  src="/img/brand-agent/requestInfoSettings.png"
  alt="alt text"
  maxWidth={900}
  imgStyle={{ border: '3px solid #3efcc2', borderRadius: '10px' }}
/>
...
<Image
  src="/img/brand-agent/notifyEndpointSettings.png"
  alt="alt text"
  maxWidth={900}
  imgStyle={{ border: '3px solid #3efcc2', borderRadius: '10px' }}
/>
...
<Image
  src="/img/brand-agent/notifyEndpointInput4.png"
  alt="alt text"
  maxWidth={900}
  imgStyle={{ border: '3px solid #3efcc2', borderRadius: '10px' }}
/>
...
<Image
  src="/img/brand-agent/notifyEndpointOutput1.png"
  alt="alt text"
  maxWidth={900}
  imgStyle={{ border: '3px solid #3efcc2', borderRadius: '10px' }}
/>
...
<Image
  src="/img/brand-agent/generateMessageSettings.png"
  alt="alt text"
  maxWidth={900}
  imgStyle={{ border: '3px solid #3efcc2', borderRadius: '10px' }}
/>
...
<Image
  src="/img/brand-agent/generateMessageOutput.png"
  alt="alt text"
  maxWidth={900}
  imgStyle={{ border: '3px solid #3efcc2', borderRadius: '10px' }}
/>
...
<Image
  src="/img/brand-agent/apiCallSettings.png"
  alt="alt text"
  maxWidth={900}
  imgStyle={{ border: '3px solid #3efcc2', borderRadius: '10px' }}
/>
...
<Image
  src="/img/brand-agent/apiCallInput.png"
  alt="alt text"
  maxWidth={900}
  imgStyle={{ border: '3px solid #3efcc2', borderRadius: '10px' }}
/>
...
<Image
  src="/img/brand-agent/agentDescription.png"
  alt="alt text"
  maxWidth={900}
  imgStyle={{ border: '3px solid #3efcc2', borderRadius: '10px' }}
/>
...
**S SmythOS** offers these embodiment options inside the Builder so we can assess the agent behavior.
...
<Image
  src="/img/brand-agent/embodiments.png"
  alt="alt text"
  maxWidth={900}
  imgStyle={{ border: '3px solid #3efcc2', borderRadius: '10px' }}
/>
...
<Image
  src="/img/brand-agent/chatbot.png"
  alt="alt text"
  maxWidth={900}
  imgStyle={{ border: '3px solid #3efcc2', borderRadius: '10px' }}
/>
