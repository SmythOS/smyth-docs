...
| [**Agents Page**](https://app.smythos.com/agents) | The dashboard where you can open, manage, and organize all your agents into different [Project Spaces](/docs/account-management/spaces-management). |
