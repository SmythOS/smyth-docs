...
og:image: /img/integrations/smythos_avesapi.png
...
* **Explore Other Integrations:** Combine AvesAPI with other SmythOS tools. Use the [Google Sheets Integration](/docs/integrations/google-sheets) to log ranking data, or connect to the [Ahrefs Integration](/docs/integrations/ahrefs) to further analyze the SEO metrics of the URLs you discover.