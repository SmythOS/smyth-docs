...
<Youtube videoId="SwmjVidu3ig" title="Chat with Agent | SmythOS" />
...
<Youtube videoId="58YnlrWBSNw" title="Bulk Processing | SmythOS" />
...
<Youtube videoId="8_gG7hUdUvo" title="Scheduler | SmythOS" />
