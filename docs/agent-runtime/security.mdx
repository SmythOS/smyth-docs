...
Sensitive data, like API keys, credentials, and tokens, is never hardcoded or exposed. Instead, SRE uses the [Vault](/docs/agent-runtime/vault) subsystem for secure, encrypted secret storage.
...
To manage secrets, visit the [Vault dashboard](/docs/agent-runtime/vault).
...
To learn more about deploying SRE in enterprise settings, see [Enterprise Deployment](/docs/agent-runtime/enterprise-deploymentment).
...
| Advanced Deployment     | [Enterprise Deployment](/docs/agent-runtime/enterprise-deploymentment)    |
...
- [Enterprise Deployment](/docs/agent-runtime/enterprise-deploymentment)
