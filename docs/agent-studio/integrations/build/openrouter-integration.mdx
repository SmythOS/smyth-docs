...
og:image: /img/integrations/smythos_openrouter.png
...
* **Explore Other Integrations:**
    * Combine OpenRouter with the [ScrapingBee Integration](/docs/integrations/scrapingbee) to scrape content from a website and then use any LLM to summarize or analyze it.
    * Generate text with an OpenRouter model and then give it a voice using the [Elevenlabs Integration](/docs/integrations/elevenlabs).
    * Use OpenRouter to process data before logging it to a [Google Sheet](/docs/integrations/google-sheets) or sending it as an [Email](/docs/integrations/email).
