...
- **[GenAI LLM](../base/genai-llm)** – Summarize or explain the parsed data.  
- **[RAG Remember](../rag-data/rag-remember)** – Store records for later retrieval.  
- **[Another Code Component](../advanced/code)** – Perform further calculations or validations.
