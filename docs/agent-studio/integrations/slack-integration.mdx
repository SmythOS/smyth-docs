...
* **Build an Agent That...**
    * Creates a daily "digest" of all new tasks created in [Asana](/docs/agent-studio/integrations/asana-integration) or [Trello](/docs/integrations/trello) and posts it in a project channel.
