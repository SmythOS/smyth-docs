...
og:image: /img/integrations/smythos_elevenlabs.png
...
* **Build an Agent That...**
    * Fetches top headlines from the [NewsAPI Integration](/docs/integrations/newsapi), and generates a daily audio news briefing.
...
* **Explore Other Integrations:**
    ...
    * Use the [ScrapingBee Integration](/docs/integrations/scrapingbee) to extract text from a website and pass it directly to the Text to Speech component.
    * Store the generated audio files in a cloud service like [OneDrive](/docs/integrations/onedrive) for long-term access.
