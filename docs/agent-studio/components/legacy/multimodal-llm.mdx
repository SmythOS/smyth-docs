...
| Field   | Description                                                                                                   |
|---------|---------------------------------------------------------------------------------------------------------------|
| **Model** | To populate the list of available models, you must first add your Google AI API key to the **[Vault](/docs/agent-collaboration/working-with-agents/vault-sharing)**. |
