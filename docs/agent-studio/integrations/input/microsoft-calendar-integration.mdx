...
* **Enhance Your Workflows by Combining Data & Actions:**
  * Use [Google Gmail Integration](/docs/agent-studio/integrations/output/google-gmail-integration) to send customized email notifications or meeting invitations with additional context beyond the standard invites.
