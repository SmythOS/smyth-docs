...
og:image: /img/integrations/smythos_newsapi.png
...
* **Explore Other Integrations:**
    * Combine NewsAPI with the [Google Sheets Integration](/docs/integrations/google-sheets) to create a historical log of media mentions.
    * Use search results to trigger alerts in [Slack](/docs/integrations/slack) or via [Email](/docs/integrations/email).
