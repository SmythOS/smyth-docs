...
<InfoCallout>
**TL;DR:** Choose from three WhatsApp integration paths: MCP Server, Meta WhatsApp Business API, or Twilio. All allow your SmythOS agent to receive and send messages over WhatsApp.
</InfoCallout>
