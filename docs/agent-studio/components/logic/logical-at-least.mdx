...
keywords: [Logic, At Least, condition, boolean, true, false, minimum, some]
...
- **Set Minimum to 1 for an OR Gate:** If you set **Minimum Inputs** to `1`, this component behaves exactly like a **[Logic OR](./logical-or)** component.
...
- Combine this with a **[ForEach Loop](../advanced/for-each)** to process a list of items and then check if at least a certain number of them returned a successful result.
