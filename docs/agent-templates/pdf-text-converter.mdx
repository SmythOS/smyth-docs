...
<Image src="/img/pdf_text_converter/Image 1.png" alt="alt text" />

3. Then, copy your Username and API key and store in a secure location.

<Image src="/img/pdf_text_converter/Image 2.png" alt="alt text" />

## Agent Setup

1. In `SmythOS`, navigate to the `Templates` tab.

<Image src="/img/pdf_text_converter/Image 3.png" alt="alt text" />
...
<Image src="/img/pdf_text_converter/Image 4.png" alt="alt text" />
...
<Image src="/img/pdf_text_converter/Image 5.png" alt="alt text" />
...
<Image src="/img/pdf_text_converter/Image 6.png" alt="alt text" />
...
<Image src="/img/pdf_text_converter/Image 7.png" alt="alt text" />
...
<Image src="/img/pdf_text_converter/Image 8.png" alt="alt text" />

3. Here’s the result!

<Image src="/img/pdf_text_converter/Image 9.png" alt="alt text" />
