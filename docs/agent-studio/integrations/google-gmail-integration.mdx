...
* **Enhance Your Workflows by Combining Data & Actions:**
    ...
    * Combine Gmail with [Google Calendar Integration](/docs/agent-studio/integrations/input/google-calendar-integration) to schedule meetings based on email exchanges or create calendar events for email follow-ups.
    * Use [Google Drive Integration](/docs/agent-studio/integrations/knowledge/google-drive-integration) to save email attachments to specific folders or attach files from Drive to outgoing emails.
