...
- **[GenAI LLM](../base/gen-ai-llm)** – Summarize or explain the parsed data.
...
- Feed your JSON output into **[GenAI LLM](../base/gen-ai-llm)** for human-readable summaries or analysis.
- Use **[RAG Remember](../rag-data/rag-remember)** to store parsed records for future queries.
- Wrap this component in an **[Agent Skill](../base/agent-skill)** to make it a reusable action for end users.
