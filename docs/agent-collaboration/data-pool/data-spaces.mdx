...
<Image src="/static/img/docs/create-data-space-popup.jpg" alt="Create Data Space modal" caption="Each Data Space represents a dedicated container of searchable documents." />
...
<Image src="/static/img/docs/add-data-source-popup.jpg" alt="Add Data Source modal in SmythOS" caption="Files and links are transformed into searchable vector embeddings." />
...
Indexing turns your files into vector embeddings. These are stored in your default or [Custom Storage](../../data/custom-stroage) setup and made available to agents via semantic search.
</InfoCallout>
...
Check file type and size. Retry if needed, or consider using [Custom Storage](../../data/custom-stroage) for more control.
...
- [Use Custom Storage integrations](../../data/custom-stroage)
