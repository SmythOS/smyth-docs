...
* **Build an Agent That...**
    ...
    * Generates product-related content. When you add a new product to your store, an agent uses an [LLM component](/docs/integrations/openrouter) to write a "Product Spotlight" article and saves it as a draft for your review.
    * Connects your content and social media. After an agent creates a new article, it takes the article's URL and shares it across your social channels using the [Ayrshare Integration](/docs/integrations/ayrshare).

* **Explore Other Integrations:**
    * Use a [Webflow](/docs/integrations/webflow) or [WordPress.org](/docs/integrations/wordpress-org) integration to pull content from another CMS and sync it with your Shopify blog.
    * Keep a log of all articles published by your agents in a [Google Sheet](/docs/integrations/google-sheets) for content tracking and performance analysis.
