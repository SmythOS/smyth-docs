...
<Image src="/img/asana_task_manager_agent/1.png" alt="alt text" />

3. Navigate to `Apps` and click `Manage Developer Apps`.

<Image src="/img/asana_task_manager_agent/2.png" alt="alt text" />

4. Click `Create New App`.

<Image src="/img/asana_task_manager_agent/3.png" alt="alt text" />
...
<Image src="/img/asana_task_manager_agent/4.png" alt="alt text" />

6. Your Client ID & Client Secret are now automatically generated. Store your credentials in a secure location, or you can add them to your vault. Click [here](https://app.smythos.com/doc/#/vault/keysManagement?id=keys) to learn more about adding your API keys to the vault.

<Image src="/img/asana_task_manager_agent/5.png" alt="alt text" />

7. Navigate to the left sidebar and click `OAuth` and click `Add Redirect URL`. 

<Image src="/img/asana_task_manager_agent/6.png" alt="alt text" />
...
<Image src="/img/asana_task_manager_agent/7.png" alt="alt text" />
...
<Image src="/img/asana_task_manager_agent/8.png" alt="alt text" />

## Agent Setup

1. In SmythOS, navigate to the templates tab.

<Image src="/img/asana_task_manager_agent/9.png" alt="alt text" />
...
<Image src="/img/asana_task_manager_agent/10.png" alt="alt text" />
...
<Image src="/img/asana_task_manager_agent/11.png" alt="alt text" />
...
<Image src="/img/asana_task_manager_agent/12.png" alt="alt text" />

Go to https://app.asana.com/api/1.0/workspaces to get your Asana Workspace Global ID. Copy your Global ID number and store it in a secure location, or you can add it to your SmythOS vault. Click [here](https://app.smythos.com/doc/#/vault/keysManagement?id=keys) to learn more about adding your keys to the vault.

Go to https://app.asana.com/api/ 1.0/projects to get your Asana Project Global ID. Use "Ctrl+F" to find the project that you want to use, e.g., SmythOS. Copy your Global ID number and store in a secure location, or you can add them to your SmythOS vault. Click [here](https://app.smythos.com/doc/#/vault/keysManagement?id=keys) to learn more about adding your keys to the vault.

3. Now, let’s input the IDs. Click the key icon and select your stored Asana Workspace Global ID from your vault.

<Image src="/img/asana_task_manager_agent/13.png" alt="alt text" />

4. Next, click the key icon and select your stored Asana Project Global ID from your vault.

<Image src="/img/asana_task_manager_agent/14.png" alt="alt text" />

5. Then, click `Save` to save your configuration.

<Image src="/img/asana_task_manager_agent/15.png" alt="alt text" />

### Get Users in a Workspace Setup

1. Go here https://developers.asana.com/reference/getusersforworkspace and copy the GET URL.

<Image src="/img/asana_task_manager_agent/16.png" alt="alt text" />
...
<Image src="/img/asana_task_manager_agent/17.png" alt="alt text" />

2. Enter your Data Space name and click the `Add Data Space` button.

<Image src="/img/asana_task_manager_agent/18.png" alt="alt text" />

3. Click on the Data Space you have created.

<Image src="/img/asana_task_manager_agent/19.png" alt="alt text" />

4. Then, click `Add Source`.

<Image src="/img/asana_task_manager_agent/20.png" alt="alt text" />
...
<Image src="/img/asana_task_manager_agent/21.png" alt="alt text" />

6. Then, wait for your data source to be fully indexed.

<Image src="/img/asana_task_manager_agent/22.png" alt="alt text" />
...
<Image src="/img/asana_task_manager_agent/23.png" alt="alt text" />
