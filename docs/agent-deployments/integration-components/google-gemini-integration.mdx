...
<InfoCallout title="TL;DR">  Add your Gemini API Key to Vault, configure an API Call component to POST to the Gemini endpoint, and handle the response. </InfoCallout>
