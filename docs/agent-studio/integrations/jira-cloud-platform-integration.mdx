...
* **Build an Agent That...**
    ...
    * Creates a daily stand-up report by fetching all issues assigned to a specific user that were updated in the last 24 hours and sending a summary to a [Microsoft Teams](/docs/integrations/microsoft-teams-integration) channel.
