...
<Image src="/img/azure_vision/Image 1.png" alt="alt text" />

4. Copy your API key using the `copy` icon. You can also click the eye icon to see your API key.

<Image src="/img/azure_vision/Image 2.png" alt="alt text" />
...
<Image src="/img/azure_vision/Image 3.png" alt="alt text" />
...
<Image src="/img/azure_vision/Image 10.png" alt="alt text" />
...
<Image src="/img/azure_vision/Image 11.png" alt="alt text" />
...
<Image src="/img/azure_vision/Image 12.png" alt="alt text" />

4. Ask the agent to analyze your image.
   1. **Prompt:** Analyze this image https://i.stack.imgur.com/sFPWe.png

<Image src="/img/azure_vision/Image 13.png" alt="alt text" />

5. Here’s the result!

<Image src="/img/azure_vision/Image 14.png" alt="alt text" />
