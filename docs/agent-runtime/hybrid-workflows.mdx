...
slug: /sre/hybrid-workflows
---

# Hybrid Workflows in SRE

SRE supports both visual and code-based agent development. You are not locked into one way of working; you can use **[Studio](/docs/agent-studio/overview)**, the **[SDK](/docs/sre/sdk-guide)**, or combine them for maximum efficiency.
...
| CI/CD & Version Control | **[SDK](/docs/sre/sdk-guide)** | Store your agent's definition in a Git repository. |
| Custom Logic & Integrations | **[SDK](/docs/sre/sdk-guide)** | Build a custom skill that queries a private API. |
...
-   [Component Library](/docs/sre/components)
-   [SRE Runtime Architecture](/docs/sre/architecture)