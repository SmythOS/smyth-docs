...
* **Explore Other Integrations:**
    * When a task is marked as "complete" in Asana, trigger an agent to send a notification to a [Microsoft Teams](/docs/integrations/microsoft-teams-integration) or [Slack](/docs/agent-studio/integrations/slack-integration) channel.
