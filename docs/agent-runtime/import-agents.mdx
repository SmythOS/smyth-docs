...
And if you’re new to building visually, you can take a quick look at the **[Studio Canvas guide](/docs/agent-studio/canvas)** before you go further.
...
- Design richer workflows with **[Studio Canvas](/docs/agent-studio/canvas)**  
