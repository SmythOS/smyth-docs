...
<Image src="/img/news_research_agent/setup1.png" alt="alt text" />
...
<Image src="/img/news_research_agent/setup2.png" alt="alt text" />

3. Click the `Create` button to complete the process.

<Image src="/img/news_research_agent/setup3.png" alt="alt text" />
...
<Image src="/img/news_research_agent/setup4.png" alt="alt text" />

2. Complete the registration form to create an account.

<Image src="/img/news_research_agent/setup5.png" alt="alt text" />

3. Copy the provided API Key.

<Image src="/img/news_research_agent/setup6.png" alt="alt text" />
...
<Image src="/img/news_research_agent/setup7.png" alt="alt text" />
...
<Image src="/img/news_research_agent/setup8.png" alt="alt text" />
...
<Image src="/img/news_research_agent/setup9.png" alt="alt text" />
