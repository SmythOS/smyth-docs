...
* **Build an Agent That...**
    * Connects to your [GitHub](/docs/integrations/github-integration) repository. When you merge a new Markdown file into your `blog` folder, the agent automatically takes the content and creates a draft on Dev.to.
...
* **Explore Other Integrations:**
    * After an agent publishes a new article using `Publish Blog`, it can take the `articleUrl` and share it across all your social channels using the [Ayrshare Integration](/docs/integrations/ayrshare-integration).
