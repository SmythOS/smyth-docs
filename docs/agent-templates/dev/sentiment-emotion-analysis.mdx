...
<Image src="/img/sentiment_emotion_analysis_agent/Image 1.png" alt="alt text" />

4. Copy your API key using the `copy` icon. You can also click the eye icon to see your API key.

<Image src="/img/sentiment_emotion_analysis_agent/Image 2.png" alt="alt text" />
...
<Image src="/img/sentiment_emotion_analysis_agent/Image 3.png" alt="alt text" />
...
<Image src="/img/sentiment_emotion_analysis_agent/Image 4.png" alt="alt text" />
...
<Image src="/img/sentiment_emotion_analysis_agent/Image 5.png" alt="alt text" />
...
<Image src="/img/sentiment_emotion_analysis_agent/Image 6.png" alt="alt text" />

6. You’re all set.

<Image src="/img/sentiment_emotion_analysis_agent/Image 7.png" alt="alt text" />
...
<Image src="/img/sentiment_emotion_analysis_agent/Image 8.png" alt="alt text" />
...
<Image src="/img/sentiment_emotion_analysis_agent/Image 9.png" alt="alt text" />

3. Upon clicking the subscribe button, you'll need to input your card details, even for the basic plan. These details will be securely stored for future purchases and subscription renewals. RapidAPI will validate your card by initiating a temporary authorization hold of $0.50. This hold will be automatically released after a few minutes or hours.
   
4. Once you've input your card details, simply click on `Add Card`.

<Image src="/img/sentiment_emotion_analysis_agent/Image 10.png" alt="alt text" />

5. Once your card details have been successfully added, the `Subscribe` button will become clickable. Simply click on it to complete the subscription process.

<Image src="/img/sentiment_emotion_analysis_agent/Image 11.png" alt="alt text" />

6. You’re all set.

<Image src="/img/sentiment_emotion_analysis_agent/Image 12.png" alt="alt text" />

## Agent Setup

1. Go to your SmythOS Dashboard and click on the `Create Agent` button.

<Image src="/img/sentiment_emotion_analysis_agent/Image 13.png" alt="alt text" />

2. The template for the `Sentiment & Emotion Analysis Agent` is readily available. Simply select it from the drop-down menu.

<Image src="/img/sentiment_emotion_analysis_agent/Image 14.png" alt="alt text" />

3. Click `Create` and allow the template to initialize and configure.

<Image src="/img/sentiment_emotion_analysis_agent/Image 15.png" alt="alt text" />

### LLM Prompt Setup

1. In SmythOS, locate the `LLM Prompt` component then click on the gear icon to access its settings.

<Image src="/img/sentiment_emotion_analysis_agent/Image 16.png" alt="alt text" />
...
<Image src="/img/sentiment_emotion_analysis_agent/Image 17.png" alt="alt text" />
...
<Image src="/img/sentiment_emotion_analysis_agent/Image 18.png" alt="alt text" />
...
<Image src="/img/sentiment_emotion_analysis_agent/Image 19.png" alt="alt text" />
