...
<Image src="/img/lead_contacts_scraper_agent/Image 16.png" alt="alt text" />
...
<Image src="/img/lead_contacts_scraper_agent/Image 17.png" alt="alt text" />
...
<Image src="/img/lead_contacts_scraper_agent/Image 18.png" alt="alt text" />
...
<Image src="/img/lead_contacts_scraper_agent/Image 19.png" alt="alt text" />
...
<Image src="/img/content_extractor/Image 20.png" alt="alt text" />

2. Provide a valid URL of the website that you want to scrape data from.

<Image src="/img/content_extractor/Image 21.png" alt="alt text" />
