...
The reference [architecture](/docs/sre/architecture) follows this general sequence:
1.  Initialize core services: storage, cache, vault, logging
2.  Register the agent manager and load available [components](/docs/sre/components)
...
Running SRE on your own machine is ideal for debugging, testing complex workflows, or building agents offline. The standard [Getting Started](/docs/sre/getting-started) guide uses a local setup by default.

- Run directly from code using the **[SDK](/docs/sre/sdk-guide)**
...
- **[Agent Architecture →](/docs/sre/architecture)**
- **[Runtime SDK Guide →](/docs/sre/sdk-guide)**
