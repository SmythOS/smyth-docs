...
<Image src="/docs/img/team-chat-agent-card.jpg" alt="Agent card with Chat button on Team Dashboard" caption="Click the Chat button to start interacting with any deployed agent in your space."/>
...
<Image src="/docs/img/create-space-flow.jpg" alt="Space creation flow in SmythOS" caption="Spaces group agents, team members, and shared tools in one place."/>
