...
og:image: /img/integrations/smythos_dataforseo.png
...
* **Explore Other Integrations:** Combine DataForSEO with other SmythOS connectors. Send SERP data to [Google Sheets](/docs/agent-studio/integrations/google-sheets-integration) for analysis, use it to trigger [Email](/docs/integrations/email) alerts, or pass URLs you find to the [Ahrefs Integration](/docs/agent-studio/integrations/ahrefs-integration) to check their backlink profiles.
